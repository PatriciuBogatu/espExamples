...
/**
 * @brief ESP32-S3-BOX-3 I2C GPIO defineation
 *
 */
...
/**
 * @brief ESP32-S3-BOX-3 SD card power control IO
 *
 */
#define GPIO_SD_POWER_CTRL (GPIO_NUM_43)

/**
 * @brief ESP32-S3-BOX-3 SDMMC GPIO defination
 *
 * @note Only avaliable when Goldfinger connected
 */
#define FUNC_SDMMC_EN (1)
#define SDMMC_BUS_WIDTH (4)
#define GPIO_SDMMC_CLK (GPIO_NUM_11)
#define GPIO_SDMMC_CMD (GPIO_NUM_14)
#define GPIO_SDMMC_D0 (GPIO_NUM_9)
#define GPIO_SDMMC_D1 (GPIO_NUM_13)
#define GPIO_SDMMC_D2 (GPIO_NUM_42)
#define GPIO_SDMMC_D3 (GPIO_NUM_12)
#define GPIO_SDMMC_DET (GPIO_NUM_NC)

/**
 * @brief ESP32-S3-BOX-3 SDSPI GPIO definationv
 *
 */
#define FUNC_SDSPI_EN (0)
#define SDSPI_HOST (SPI2_HOST)
#define GPIO_SDSPI_CS (GPIO_NUM_12)
#define GPIO_SDSPI_SCLK (GPIO_NUM_11)
#define GPIO_SDSPI_MISO (GPIO_NUM_14)
#define GPIO_SDSPI_MOSI (GPIO_NUM_9)

/**
 * @brief ESP32-S3-BOX-3 I2S GPIO defination
 *
 */
